...
bool ArrowCalssifier::calc_arrow_direction(const cv::Mat& image, const cv::Rect rect, autoware_msgs::LampState& state)
{
...
bool ColorClassifier::get_params(const ros::NodeHandle& pnh)
{
    ...
    lower_ranges_.push_back(cv::Scalar(green_h_min, green_s_min, green_v_min));
    upper_ranges_.push_back(cv::Scalar(green_h_max, green_s_max, green_v_max));

    lower_ranges_.push_back(cv::Scalar(yellow_h_min, yellow_s_min, yellow_v_min));
    upper_ranges_.push_back(cv::Scalar(yellow_h_max, yellow_s_max, yellow_v_max));

    lower_ranges_.push_back(cv::Scalar(red_h_min, red_s_min, red_v_min));
    upper_ranges_.push_back(cv::Scalar(red_h_max, red_s_max, red_v_max));
